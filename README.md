...
설정: `supabase/schema.sql`을 적용하고, 승인할 인증 사용자를 `reader_members`에 추가합니다. `reader-private` 비공개 버킷에 `catalogue-2027-sutuk-suwan-v2.json`을 업로드합니다. `src/config.js`에는 프로젝트 URL과 공개 publishable/anon 키만 설정합니다.
